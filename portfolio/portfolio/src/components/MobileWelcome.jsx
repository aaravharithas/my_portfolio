...
export default function MobileWelcome({ onComplete }) {
          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                className="w-20 h-20 rounded-full bg-gradient-to-r from-gray-400 via-gray-500 to-gray-600 flex items-center justify-center"
              >
                <motion.div
                  animate={{
